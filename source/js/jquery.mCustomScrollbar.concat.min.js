        ...
        var t, o = "mCustomScrollbar",
            ...
            w = function() {
                var t = e(this),
                    ...
                    l = ["<a href='#' title='" + d[13] + "' class='" + d[13] + "' oncontextmenu='return false;' " + r + " />", "<a href='#' title='" + d[14] + "'  class='" + d[14] + "' oncontextmenu='return false;' " + r + " />", "<a href='#' title='" + d[15] + "'  class='" + d[15] + "' oncontextmenu='return false;' " + r + " />", "<a href='#' title='" + d[16] + "'  class='" + d[16] + "' oncontextmenu='return false;' " + r + " />"],
